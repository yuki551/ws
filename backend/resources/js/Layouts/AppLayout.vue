<template>
    <div class="min-h-screen bg-gray-100">
        <nav class="hd-navi bg-white border-b border-gray-100">
            ...
            <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }" class="sm:hidden">
                ...
                <div class="pt-4 pb-1 border-t border-gray-200">
                    ...
                    <div class="mt-3 space-y-1">
                        ...
                        <jet-responsive-nav-link :href="route('post.create')" v-if="$page.user.role_id != 3">
                            日報登録
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :href="route('post.index')">
                            日報一覧
                        </jet-responsive-nav-link>
                        ...
                        <jet-responsive-nav-link :href="route('user.create')" v-if="$page.user.auth_id == 1">
                            社員登録
                        </jet-responsive-nav-link>
                        ...
                        <jet-responsive-nav-link :href="route('clients_create.index')" v-if="$page.user.current_team_id == 3 || $page.user.current_team_id == 4">
                            取引先登録
                        </jet-responsive-nav-link>

                        <jet-responsive-nav-link :href="route('clientlists.index')">
                            取引先一覧
                        </jet-responsive-nav-link>
